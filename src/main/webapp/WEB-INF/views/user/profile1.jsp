        ...
        <div class="col-lg-3 col-md-3 hidden-sm hidden-xs">
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-footer">
                    ...
                    <hr>
                    <small><a href="#">diasporafoundation.org</a></small><br>
                    <small><a href="#">Wiki</a></small><br>
                    <small><a href="#">What’s new?</a></small><br>
                    <small><a href="#">Code 1.2.34.5-a6bc7d8ef</a></small><br>
                    <small><a href="#">Pod statistics</a></small><br>
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <textarea class="form-control" rows="2" placeholder="Start a conversation..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
