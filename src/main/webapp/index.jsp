...
<html lang="en" ng-app="homeController">
  <head>
    ...
    <meta name="author" content="AIT ZEOUAY Amrane">
    <link rel="icon" href="../../favicon.ico">
    <title>Flat Discovery - Look for informations about your flat</title>
    ...
    <link href="${pageContext.request.contextPath}/resources/css/animate-custom.css" rel="stylesheet">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
      ...
      <div class="container">
		...
		<div class="container" id="services" name="services">
			...
			<div class="row">
				...
				<br>
				<div class="col-lg-offset-2 col-lg-8">
					<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/iphone.png" alt="">
				</div><!-- col -->
			</div><!-- row -->
		</div><!-- container -->
		...
		<br>
			<div class="row white centered">
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="${pageContext.request.contextPath}/resources/img/team/team01.jpg" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="${pageContext.request.contextPath}/resources/img/team/team02.jpg" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="${pageContext.request.contextPath}/resources/img/team/team03.jpg" height="120px" width="120px" alt="">
					<br>
				...
				<div class="col-lg-3 centered">
					<img class="img img-circle" src="${pageContext.request.contextPath}/resources/img/team/team04.jpg" height="120px" width="120px" alt="">
					<br>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 centered">
						<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/macbook.png" align="">
					</div>
					<div class="col-lg-4">
						<h2>We Are Hiring!</h2>
		...
		<br>
			...
			<div class="row">	
				...
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/portfolio/folio01.jpg" alt="">
							<figcaption>
								<h5>DASHBOARD</h5>
						    ...
						    <div class="modal-dialog">
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          <p><img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/portfolio/folio01.jpg" alt=""></p>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/portfolio/folio02.jpg" alt="">
							<figcaption>
								<h5>UI DESIGN</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/portfolio/folio03.jpg" alt="">
							<figcaption>
								<h5>ANDROID PAGE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
			...
			<div class="row">	
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/portfolio/folio04.jpg" alt="">
							<figcaption>
								<h5>PROFILE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/portfolio/folio05.jpg" alt="">
							<figcaption>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/portfolio/folio06.jpg" alt="">
							<figcaption>
								<h5>PHONE MOCKUP</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
		...
		<br>
			...
			<div class="row">
				<div class="col-lg-6 blog-bg">
					...
					<br>
						<p><img class="img img-circle" src="${pageContext.request.contextPath}/resources/img/team/team04.jpg" width="60px" height="60px"></p>
						<h4>Jaye Smith</h4>
				...
				<div class="col-lg-6 blog-bg">
					<div class="col-lg-4 centered">
					<br>
						<p><img class="img img-circle" src="${pageContext.request.contextPath}/resources/img/team/team03.jpg" width="60px" height="60px"></p>
						<h4>Michele Lampa</h4>
		...
		<div id="footerwrap">
			<div class="container">
				<h4>Created by <a href="http://blacktie.co">BlackTie.co</a> - Copyright <p>&copy; <% Date date = new Date(); out.print(date.getYear()+1900); %> </h4>
			</div>
		</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery-func.js"></script>
	
	
	<script src="${pageContext.request.contextPath}/resources/js/classie.js"></script>
	<script src="${pageContext.request.contextPath}/resources/js/uisearch.js"></script>
	<script>
